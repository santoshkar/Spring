...
public class EmployeeDao extends NamedParameterJdbcDaoSupport {
	...
	public Employee findById(long id) {
		...
		return getNamedParameterJdbcTemplate().queryForObject("SELECT empId, name, sal FROM EMP "
	...
	public List<Employee> findByDepartmentIdAndSalary(long deptId, double salary) {
		...
		return getNamedParameterJdbcTemplate().query("select empId, name, sal FROM emp "
